...
class DQN:
    """
    DQN is vanilla deep q learning network
    """
    ...
    def train_Q_network(self, pre_train=False, update=True):
        ...
        Q_select = self.Q_select.eval(feed_dict={self.select_input: next_state_batch})      #policy network
        Q_eval = self.Q_eval.eval(feed_dict={self.eval_input: next_state_batch})            #target network
